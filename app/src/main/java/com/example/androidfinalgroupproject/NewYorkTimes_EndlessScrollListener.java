...
public abstract class NewYorkTimes_EndlessScrollListener implements AbsListView.OnScrollListener {
    ...
    public NewYorkTimes_EndlessScrollListener() {
    }

    public NewYorkTimes_EndlessScrollListener(int visibleThreshold) {
        this.visibleThreshold = visibleThreshold;
    }

    public NewYorkTimes_EndlessScrollListener(int visibleThreshold, int startPage) {
        this.visibleThreshold = visibleThreshold;
